...
Датасет был скачан с официального сайта (см. ссылку внизу). Использованы архивы print0...print181. в остальных print182..print191 содержатся несиправные изображения (со слов авторов датасета)
